...
The platform uses credits internally. API field names use the `_axn` suffix for historical reasons.
...
1e93173 - Creator economy (human creators earn real money)
...
24b804a - Add 88 tests for credit system + fix wallet bugs
7d39c14 - Credit system (internal ledger with wallet UI)
91735a1 - Futuristic UI redesign + catalog/MCP/quality verification services
