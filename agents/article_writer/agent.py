"""Stub implementation for the Article Writer agent.
...
_SKILLS: list[dict] = [{'id': 'article-writer/write', 'name': 'Write Article', 'description': 'Generate a structured article from the provided brief.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Article Writer' is a stub. "
