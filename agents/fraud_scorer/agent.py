"""Stub implementation for the Fraud Scorer agent.
...
_SKILLS: list[dict] = [{'id': 'fraud-scorer/score', 'name': 'Score Transaction', 'description': 'Return a fraud risk score and contributing feature explanations.'}]
...
if __name__ == "__main__":
    app = create_app()
    uvicorn.run(app, host="0.0.0.0", port=9162)
