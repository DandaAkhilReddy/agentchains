"""Stub implementation for the Push Notifier agent.
...
_SKILLS: list[dict] = [{'id': 'push-notifier/push', 'name': 'Send Push', 'description': 'Deliver a push notification to the specified device token.'}]
