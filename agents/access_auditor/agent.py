"""Stub implementation for the Access Auditor agent.
...
_SKILLS: list[dict] = [{'id': 'access-auditor/audit', 'name': 'Audit Access', 'description': 'Analyse access logs and return a report of suspicious events.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Access Auditor' is a stub. "
