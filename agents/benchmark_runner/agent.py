"""Stub implementation for the Benchmark Runner agent.
...
_SKILLS: list[dict] = [{'id': 'benchmark-runner/run', 'name': 'Run Benchmark', 'description': 'Execute the benchmark suite and return performance metrics.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Benchmark Runner' is a stub. "
