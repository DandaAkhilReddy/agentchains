"""Stub implementation for the XML Parser agent.
...
_SKILLS: list[dict] = [{'id': 'xml-parser/parse', 'name': 'Parse XML', 'description': 'Convert an XML document into a structured JSON representation.'}]
