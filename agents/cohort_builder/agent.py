"""Stub implementation for the Cohort Builder agent.
...
_SKILLS: list[dict] = [{'id': 'cohort-builder/build', 'name': 'Build Cohort', 'description': 'Define and materialise a user cohort from the supplied criteria.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "agent": "cohort-builder",
        "message": (
            "Agent 'Cohort Builder' is a stub. "
