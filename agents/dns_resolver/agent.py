"""Stub implementation for the DNS Resolver agent.
...
_SKILLS: list[dict] = [{'id': 'dns-resolver/resolve', 'name': 'Resolve DNS', 'description': 'Return all DNS records for the given domain from multiple resolvers.'}]
