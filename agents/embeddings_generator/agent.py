"""Stub implementation for the Embeddings Generator agent.
...
_SKILLS: list[dict] = [{'id': 'embeddings-generator/embed', 'name': 'Generate Embeddings', 'description': 'Produce a float vector embedding for the given text.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Embeddings Generator' is a stub. "
