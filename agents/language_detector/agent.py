"""Stub implementation for the Language Detector agent.
...
_SKILLS: list[dict] = [{'id': 'language-detector/detect', 'name': 'Detect Language', 'description': 'Return BCP-47 language tag and confidence for the input.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Language Detector' is a stub. "
