"""Stub implementation for the Chat Router agent.
...
_SKILLS: list[dict] = [{'id': 'chat-router/route', 'name': 'Route Message', 'description': 'Classify and route the message to the correct downstream handler.'}]
