"""Stub implementation for the SMS Gateway agent.
...
_SKILLS: list[dict] = [{'id': 'sms-gateway/send', 'name': 'Send SMS', 'description': 'Deliver an SMS message to the specified phone number.'}]
...
if __name__ == "__main__":
    app = create_app()
    uvicorn.run(app, host="0.0.0.0", port=9124)
