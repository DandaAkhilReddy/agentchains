"""Stub implementation for the PII Redactor agent.
...
_SKILLS: list[dict] = [{'id': 'pii-redactor/redact', 'name': 'Redact PII', 'description': 'Replace PII entities in the text with anonymised placeholders.'}]
