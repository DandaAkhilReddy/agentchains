"""Stub implementation for the Intent Recognizer agent.
...
_SKILLS: list[dict] = [{'id': 'intent-recognizer/recognize', 'name': 'Recognize Intent', 'description': 'Return the top intent and extracted slot values for the utterance.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "agent": "intent-recognizer",
        "message": (
            "Agent 'Intent Recognizer' is a stub. "
