"""Stub implementation for the Slack Notifier agent.
...
_SKILLS: list[dict] = [{'id': 'slack-notifier/notify', 'name': 'Notify Slack', 'description': 'Send a structured notification to the specified Slack channel.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Slack Notifier' is a stub. "
