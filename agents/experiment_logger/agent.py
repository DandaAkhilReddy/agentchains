"""Stub implementation for the Experiment Logger agent.
...
_SKILLS: list[dict] = [{'id': 'experiment-logger/log', 'name': 'Log Experiment', 'description': 'Record experiment configuration and results in the experiment store.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Experiment Logger' is a stub. "
