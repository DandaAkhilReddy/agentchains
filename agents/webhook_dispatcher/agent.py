"""Stub implementation for the Webhook Dispatcher agent.
...
_SKILLS: list[dict] = [{'id': 'webhook-dispatcher/dispatch', 'name': 'Dispatch Webhook', 'description': 'POST a signed event payload to the registered webhook URL.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Webhook Dispatcher' is a stub. "
