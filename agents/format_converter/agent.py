"""Stub implementation for the Format Converter agent.
...
_SKILLS: list[dict] = [{'id': 'format-converter/convert', 'name': 'Convert Format', 'description': 'Transcode data from a source format into the requested target format.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "message": (
            "Agent 'Format Converter' is a stub. "
