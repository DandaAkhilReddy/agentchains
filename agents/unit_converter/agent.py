"""Stub implementation for the Unit Converter agent.
...
_SKILLS: list[dict] = [{'id': 'unit-converter/convert', 'name': 'Convert Units', 'description': 'Return the value converted from the source unit to the target unit.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "agent": "unit-converter",
        "message": (
            "Agent 'Unit Converter' is a stub. "
