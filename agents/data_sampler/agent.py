"""Stub implementation for the Data Sampler agent.
...
_SKILLS: list[dict] = [{'id': 'data-sampler/sample', 'name': 'Sample Dataset', 'description': 'Return a random or stratified sample from the input data.'}]
