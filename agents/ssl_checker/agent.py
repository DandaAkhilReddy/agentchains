"""Stub implementation for the SSL Checker agent.
...
_SKILLS: list[dict] = [{'id': 'ssl-checker/check', 'name': 'Check SSL', 'description': 'Return certificate chain, expiry, and cipher suite details.'}]
