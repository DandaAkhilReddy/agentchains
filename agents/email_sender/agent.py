"""Stub implementation for the Email Sender agent.
...
_SKILLS: list[dict] = [{'id': 'email-sender/send', 'name': 'Send Email', 'description': 'Deliver an email message to one or more recipients.'}]
