"""Stub implementation for the Knowledge Grapher agent.
...
_SKILLS: list[dict] = [{'id': 'knowledge-grapher/graph', 'name': 'Build Knowledge Graph', 'description': 'Extract entities and relations and return a graph structure.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "agent": "knowledge-grapher",
        "message": (
            "Agent 'Knowledge Grapher' is a stub. "
