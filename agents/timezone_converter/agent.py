"""Stub implementation for the Timezone Converter agent.
...
_SKILLS: list[dict] = [{'id': 'timezone-converter/convert', 'name': 'Convert Timezone', 'description': 'Return the datetime expressed in the target IANA timezone.'}]
...
async def handle_task(skill_id: str, message: str, params: dict) -> dict:
    ...
    return {
        ...
        "agent": "timezone-converter",
        "message": (
            "Agent 'Timezone Converter' is a stub. "
