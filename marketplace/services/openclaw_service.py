...
EVENT_MESSAGES = {
    "demand_spike": "📈 Demand spike on AgentChains: '{query_pattern}' in {category} (velocity: {velocity}). Consider creating a listing to earn USD!",
    ...
    "transaction_completed": "✅ Transaction completed: ${amount_usdc:.2f} earned from selling '{listing_title}'.",
