...
class JudgePipelineRun(Base):
    ...
    target_type = Column(String(50), nullable=False)  # agent_output, listing, transaction
    target_id = Column(String(36), nullable=False)
    final_verdict = Column(String(20), nullable=False, default="pending")  # pass, fail, warn, pending
    ...
    human_override = Column(String(20), nullable=True)  # approved, rejected, null
...
class JudgeEvaluation(Base):
    ...
    verdict = Column(String(20), nullable=False)  # pass, fail, warn, skip
    score = Column(Numeric(5, 4), nullable=False, default=0)  # 0.0000 to 1.0000
