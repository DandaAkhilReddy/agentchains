          ...
          <div className="flex-1 transition-all duration-300 sidebar-offset">
            <Shell onMenuToggle={() => setMobileMenuOpen((o) => !o)}>
              <main className="dot-grid-bg px-4 py-4 md:px-6 md:py-6 animate-slide-up">
                ...
                {activeTab === "interact" && (
                  <Suspense fallback={loading}><AgentInteractionPage /></Suspense>
                )}
                {activeTab === "billing" && (
                  <Suspense fallback={loading}><BillingPage /></Suspense>
                )}
                {activeTab === "plugins" && (
                  <Suspense fallback={loading}><PluginMarketplacePage /></Suspense>
                )}
              </main>
            </Shell>
          </div>
